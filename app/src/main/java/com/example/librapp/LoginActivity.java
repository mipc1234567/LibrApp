    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                String contraseña =ContraseñaUsuario.getText().toString();
                             ...
                             if (awesomeValidation.validate()){
                                 System.out.println("si paso validacion Registrar");
                                firebaseAuth.createUserWithEmailAndPassword(correo,contraseña).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()){
                                            Toast.makeText(LoginActivity.this,"usuario registrado con exito",Toast.LENGTH_SHORT).show();
                                        finish();
                                            MenuPrincipal(v);
                                        }else{
                                 ...
                                 Toast.makeText(LoginActivity.this,"complete los recuadros fallo registro",Toast.LENGTH_SHORT).show();
                             }
        ...
        IngresarLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (awesomeValidation.validate()){
                    System.out.println("si paso validacion Registrar");
                    firebaseAuth.getInstance().signInWithEmailAndPassword(NumeroUsuario.getText().toString(),ContraseñaUsuario.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(LoginActivity.this,"Usuario ingreso con exito",Toast.LENGTH_SHORT).show();
                                finish();
                                MenuPrincipal(v);
                            }else{
                    ...
                    Toast.makeText(LoginActivity.this,"complete los recuadros fallo ingreso",Toast.LENGTH_SHORT).show();
                }
